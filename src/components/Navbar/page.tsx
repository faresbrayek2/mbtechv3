            ...
            <div className="max-w-4xl ">
              <div className="flex space-x-4 sticky top-0 z-50 bg-black/60 px-1 py-[3px] rounded-full border border-black">
                <ul className="flex w-full justify-between">
                  ...
                  >
                    <div className="absolute inset-0  mix-blend-difference"></div>
                  ...
                  <button className="relative flex items-center justify-center px-4 py-2 text-lg cursor-pointer font-medium outline-none transition focus-visible:outline-2">
                    <div className="z-20 flex items-center">
                      <svg
                        width="24"
                        height="24"
